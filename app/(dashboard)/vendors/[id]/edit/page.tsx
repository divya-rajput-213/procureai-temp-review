...
export default function EditVendorPage() {
  ...
  if (isLoading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 200, color: '#9a9a96', fontSize: 13 }}>
        Loading vendor…
      </div>
    )
  }
  ...
  if (!vendor) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 200, color: '#A32D2D', fontSize: 13 }}>
        Vendor not found.
      </div>
    )
  }
