            ...
            <Card className="overflow-hidden">
                ...
                <div className="grid grid-cols-3 divide-x border-b">
                    <div className="px-3 py-3 sm:px-5 sm:py-4">
                        <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">Total Items</p>
                        <p className="text-2xl sm:text-3xl font-bold text-foreground">{allCount}</p>
                    </div>
                    <div className="px-3 py-3 sm:px-5 sm:py-4">
                        <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">New Items</p>
                        <div className="flex items-end gap-1.5">
                            <p className="text-2xl sm:text-3xl font-bold text-blue-600">{newCount}</p>
                            {newCount > 0 && (
                                <span className="mb-0.5 text-[10px] sm:text-xs text-blue-500 font-medium">
                    ...
                    <div className="px-3 py-3 sm:px-5 sm:py-4">
                        <p className="text-[10px] sm:text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">Duplicates</p>
                        <div className="flex items-end gap-1.5">
                            <p className="text-2xl sm:text-3xl font-bold text-amber-500">{duplicatesCount}</p>
                            {duplicatesCount > 0 && (
                                <span className="mb-0.5 text-[10px] sm:text-xs text-amber-500 font-medium">
